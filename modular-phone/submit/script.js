/* 手机端投稿逻辑 - 全硬编码数据版本 (免 JSON) */
(function() {
    "use strict";
    
    // 获取容器
    const rulesEl = document.getElementById('phone-rules-content');
    const methodEl = document.getElementById('phone-method-content');
    const templateEl = document.getElementById('phone-template-content');
    const quickEl = document.getElementById('phone-quick-submit-content');
