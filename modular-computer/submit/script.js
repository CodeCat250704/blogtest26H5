/* 电脑端投稿逻辑 - 全硬编码数据版本 (免 JSON) */
(function() {
    "use strict";
    
    // 获取容器
    const rulesEl = document.getElementById('pc-rules-content');
    const methodEl = document.getElementById('pc-method-content');
    const templateEl = document.getElementById('pc-template-content');
    const quickEl = document.getElementById('pc-quick-submit-content');

    // 直接在这里写死全部数据，100% 无视外界 JSON
    const data = [
        {
            "section": "rules",
            "content": [
